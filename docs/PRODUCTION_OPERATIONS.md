...
CONNECT to `api.openai.com:443`, `hooks.slack.com:443`, and regional `ssm.<region>.amazonaws.com:443` endpoints and denies every other destination. It has no host
