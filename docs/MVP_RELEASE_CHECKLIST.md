...
- [x] Restrict Production Backend and Celery Worker egress through a no-log allowlist proxy for approved destinations (OpenAI, Slack Incoming Webhook, and regional AWS SSM HTTPS endpoints).
