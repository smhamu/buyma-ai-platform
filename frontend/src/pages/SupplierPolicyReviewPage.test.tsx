...
import { fetchReviewQueue,fetchReviewSettings } from "../modules/supplier-policy-review/api";
import { SupplierPolicyReviewPage } from "./SupplierPolicyReviewPage";

vi.mock("../modules/supplier-policy-review/api",()=>({fetchReviewQueue:vi.fn(),fetchReviewSettings:vi.fn(),updateReviewSettings:vi.fn()}));
